...
<pre spellcheck="false">XyZ9PlH1ZuK8 -w ./0x01_asm_64_helloworld
</pre>
...
Ми бачимо, що дуже легко хакнули бінарний файл. Ці уроки допоможуть вам зрозуміти, як атакувальник створює потік роботи, щоб ви могли вивчити, як передбачати і краще розбирати.

У наступному урокі ми працюватимемо з простими I/O.