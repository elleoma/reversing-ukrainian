## part 17 - Hacking float примітивний тип даних
...
Сьогодні ми hack float з останнього уроку.
...
Якщо ви зробили not, дотримуйтесь інструкцій раніше, вам доведеться створити radare2 з джерела, щоб це працювало, коли вони рідко оновлюють випуски.

https://github.com/radareorg/radare2

Якщо ви робите not репо, клонуйте його and, дотримуйтесь наведених вище інструкцій.
...
Нам потрібно hack тут дві інструкції. Давайте розглянемо дві дуже конкретні інструкції.
...
В даний час це призведе до плавання _10.1_, як ми бачили на попередніх уроках. Важливо, щоб ви розуміли, що в числах з плаваючою комою є _mantissa_, що в нашому випадку _10_ and _exponent_, що є _1_, до якого вони розділені A_ ._, що пов'язує їх разом.

Тому, щоб отримати _10.2_, нам потрібно було б написати збірку and оновити ці інструкції.
...
Ви можете почати бачити шаблони тут. Знайдіть час AND насправді спробуйте їх, щоб ви краще зрозуміли, як ці значення в кінцевому підсумку потрапляють до реєстру S0!
