...
Kali Linux RaspberryPi 2 (v1.2), 3 і 4 (64-бітний) (img.xz) __ __
...
Отримавши всі необхідні пристрої та програмне забезпечення, перегляньте відео про те, як налаштувати своє середовище, оскільки Null Byte зробив дивовижну роботу з покроковим підручником, який отримає налаштування за лічені хвилини.

Наступним кроком є ​​те, щоб Git Clone та створити програмне забезпечення Radare2, оскільки цього ми хочемо останню версію, оскільки стандартна версія, вбудована в KALI, буде недостатньою для наших потреб.

__Git клон &amp; побудувати Radare2 програмне забезпечення__
...
Нарешті ми будемо використовувати текстовий редактор для створення нашого коду. У Калі вбудовано як редактори тексту VIM, так і нано. Ми будемо використовувати VIM, але ви вільні використовувати будь -який вам зручний.
