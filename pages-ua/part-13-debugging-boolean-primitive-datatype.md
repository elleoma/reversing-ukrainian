...
Ми бачимо в _0x55718999bc_ _movz w0, 0x1_ або переміщення _0x1_ в _w0_, який є нашим булевим true. Пам'ятайте, що ваш адрес буде відрізнятися через ASLR.
...
Дуже просто ми зупинилися перед тим, як значення _0x1_ було розміщене в _w0_, а потім ми зробили крок і побачили, що воно справді знаходилося в _0x1_ всередині _w0_ після кроку. Це означає, що наш програма успішно розмістила _1_ або _true_ в регістр _w0_, що збігається з тим, що створила наша джерельна код.
