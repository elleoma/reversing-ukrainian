...
Встановимо breakpoint на _0x55718999BC_ and Перевірте вміст.
...
Дуже просто ми зламали прямо перед значенням _0x1_ мали бути розміщені в _w0_ and, тоді ми ступили and, що це насправді _0x1_ всередині _w0_ після кроку. Це означає, що наша програма успішно вкладає _1 _or _true_ в регістр _w0_, який відповідає тому, що створив наш вихідний код.
...
На нашому наступному уроці ми будемо hack boolean, щоб зробити це 0.