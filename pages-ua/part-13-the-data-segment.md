...
1)байт - ми використовуємо позначення db, яке очевидно 1 байт або 8 бітів.

2)слово - ми використовуємо dw і воно має довжину 2 байти.

3)двосліво - ми використовуємо dd для призначення і вони мають довжину 4 байти.

4)квадросліво - ми використовуємо dq, яке має довжину 8 байтів.

5)xmm-слово - ми використовуємо xmmword, яке має довжину 16 байтів.

6)ymm-слово - ми використовуємо ymmword, яке має довжину 32 байти.

Є математичні регістри SSE, які окремі від процесора, які містять наступні:

1)real4 - Це єдиний або те, що ви вважаєте за плаваючий точці числа, оскільки воно має довжину 4 байти.

2)real8 - Це подвійний плаваючий точці, оскільки воно має довжину 8 байтів.
...
Ми побачимо це в коді, коли ми станемо більш досвідченими в серії, але критично важливо, щоб ви зрозуміли змінні всередині функції є місцевими і потрапляють на стека, оскільки вони не існують протягом усієї програми. Ці змінні, які є частиною сегменту даних, не місцеві, вони глобальні і потрапляють на стік.
