...
Сьогодні ми поговоримо про перший із примітивного C ++. _Char_ Dataype використовується для зберігання одного символу і повинен бути оточений одиночними цитатами.
...
Потім ми друкуємо його на stdout і нічого більше.
