...
Значення кожного з контрольних реєстрів не можна безпосередньо звертатися до нього, але дані в контрольному реєстрі можна перемістити в один з загальних регістрів, а коли дані будуть в регістрі GP, програма може досліджувати флаги бітів в реєстрі, щоб визначити режим роботи процесора разом з поточним виконуваним завданням.
