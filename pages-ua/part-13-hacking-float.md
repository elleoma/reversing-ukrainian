...
Давайте переглянем наш приклад.&nbsp;__0x05\_float.c__&nbsp;as_.
...
Флоат знаходиться під&nbsp;_\[XyZ9PlH24ZuK8\]_.

<pre spellcheck="false">:&gt; pff @ [0x00000340]
0x00004000 = 9.32830524e-09
</pre>

Як ми вже говорили в останньому урокі, не хвилюйтеся, що флоат не дуже точний, оскільки ця машина x64. Що важливо побачити - значення&nbsp;_0x00004000_.

У нашому останньому урокі ми також пояснили, як обробляє флоати Pico. Давайте переглянемо деякі основи.
...
Отже, нам потрібно змінити значення наступного.

<pre spellcheck="false">wx 0x0000f03f @ 0x00000340
</pre>

Усі, що потрібно зробити зараз - вийти і перетворити нашу&nbsp;__.elf&nbsp;__на&nbsp;__.uf2__!

<pre spellcheck="false">./elf2uf2/elf2uf2 0x05_float.elf 0x05_float.uf2
</pre>

Під'єднайте Pico і переконайтеся, що натискаєте кнопку BOOTSEL або використовуйте налаштування, які я надав у частині 2.
...
У нас тепер змінено значення на 1.000000 і ми дали 1 секунду, щоб воно збереглося.

У наступному урокі ми розберемося з типом даних double.