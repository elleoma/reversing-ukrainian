...
Сьогодні ми починаємо нашу роботу з мови C++. Величезна більшість шкідливого програмного забезпечення написана на C++ і проходження простих прикладів коду протягом наступних місяців і розбір їх у дебагері нададуть вам справжній практичний підхід до вивчення справжньої роботи з кодом.

Ми використовуватимемо Kali Linux далі разом з Radare 2. Ви можете завантажити VirtualBox і завантажити Kali Linux x64 Appliance, щоб слідувати за цим.

Давайте почнемо з прикладу коду C++ 1:

<XyZ9PlH3ZuK8 class="slate-resizable-image-embed slate-image-embed__resize-full-width"><img src="/imgs/1561023464535.jpg"/></XyZ9PlH4ZuK8>
